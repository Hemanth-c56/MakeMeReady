...
import { Lightbulb, MessageCircle, Sparkles, Users, Loader2 } from 'lucide-react';
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-4 md:flex-col md:items-end md:gap-6">
              ...
              <Button
                ...
                disabled={isStarting}
                className="h-auto bg-linear-to-r from-rose-500 to-pink-500 px-8 py-6 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:from-rose-600 hover:to-pink-600 hover:shadow-xl disabled:opacity-50">
