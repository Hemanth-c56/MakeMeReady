    ...
    <div className="flex h-screen w-full items-center justify-center bg-zinc-950 p-4">
      <div className="w-full max-w-sm rounded-xl border border-zinc-800 bg-zinc-900 p-8 shadow-xl">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-zinc-400">Enter your credentials to access your portal</p>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            {form.formState.isSubmitting ? "Brewing Connection..." : "Sign In"}
          </button>
        </form>

        <p className="mt-6 text-center text-sm text-zinc-400">
          Don't have an account?{" "}
          <a href="/register" className="font-medium text-emerald-500 hover:text-emerald-400 hover:underline">
            Register now
          </a>
        </p>
      </div>
